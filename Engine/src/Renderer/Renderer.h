...
namespace Karem {
	...
	public:
		...
		static void SubmitQuad(const glm::mat4& transform, const Rahman::SmartRef<Texture2D> texture, float texIndex = 1.0f, const glm::vec4& color = glm::vec4(1.0f));
		...
		static void SubmitRotatedQuad(const glm::vec4& pos, const glm::vec2& size, float rotation, Rahman::SmartRef<Texture2D> texture, float texIndex = 1.0f, const glm::vec4& color = glm::vec4(1.0f));
